...
class WorldManager:
    ...
    #creates the world and sets the initial room and map.
    ...
    #draw the current room and next room
    ...
    #checks if player goes through one of 4 possible doors
    def detect_next_room(self):  
    ...
    #initialize to go to the next room
