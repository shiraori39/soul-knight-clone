...
#Coin class inherited from object class
class Coin(Object):
    x = None
    y = None
    name = 'coin'
...
class Ruby(Coin):
    ...
    def __init__(self, game, room=None):
        super().__init__(game, room)
        self.value = 15
#to make the coins bounce when dropped
class Bounce:
