...
#a function to get all the frames from assets
...
#Class for managing an entity's animations
class EntityAnimation:
    def __init__(self, entity, death_anim=4, speed=25):
        ...
        self.speed = speed
    #get the velocity to update coordiantes
